################################################################################
##   DDRAtlas — Pan-cancer alteration landscape of the DNA-damage repair machinery
...
##   GitHub : https://github.com/siddugayam/DDRAtlas
...
GENE_ORDER    <- c("BRCA1", "BRCA2", "PALB2", "RAD51", "RAD51C", "ATM", "ATR", "CHEK1", "CHEK2", "TP53BP1", "MLH1", "MSH2", "MSH6", "PMS2", "ERCC1", "ERCC2", "XPA", "PARP1", "FANCA", "PRKDC")
GENE_CATEGORY <- c("BRCA1"="Homologous recombination", "BRCA2"="Homologous recombination", "PALB2"="Homologous recombination", "RAD51"="Homologous recombination", "RAD51C"="Homologous recombination", "ATM"="Checkpoint / signalling", "ATR"="Checkpoint / signalling", "CHEK1"="Checkpoint / signalling", "CHEK2"="Checkpoint / signalling", "TP53BP1"="Checkpoint / signalling", "MLH1"="Mismatch repair", "MSH2"="Mismatch repair", "MSH6"="Mismatch repair", "PMS2"="Mismatch repair", "ERCC1"="Nucleotide excision", "ERCC2"="Nucleotide excision", "XPA"="Nucleotide excision", "PARP1"="BER / FA / NHEJ", "FANCA"="BER / FA / NHEJ", "PRKDC"="BER / FA / NHEJ")
CAT_COLORS    <- c("Homologous recombination"="#534AB7", "Checkpoint / signalling"="#1D9E75", "Mismatch repair"="#D85A30", "Nucleotide excision"="#185FA5", "BER / FA / NHEJ"="#D4537E")
...
combined <- (fig2 | fig4) / (fig3 + theme(plot.margin = unit(c(0,1,0,0),"cm"))) +
  ...
  plot_annotation(title = "DDRAtlas: Pan-cancer alteration landscape of the DNA-damage repair machinery",
    subtitle = paste0("TCGA PanCancer Atlas 2018 - ", NGENES, " genes - 32 tumour types - n = 10,195"),
    caption = "Data: cBioPortal public API - github.com/siddugayam/DDRAtlas",
